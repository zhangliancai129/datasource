 ...
 */
@Component
@ConfigurationProperties(prefix = OraclePageHelperProperties.PAGEHELPER_PREFIX)
public class OraclePageHelperProperties {

    static final String PAGEHELPER_PREFIX = "pagehelper.oracle";
